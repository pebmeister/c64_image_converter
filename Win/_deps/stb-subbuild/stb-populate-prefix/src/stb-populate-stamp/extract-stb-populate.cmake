...
#
get_filename_component(filename "C:/Users/Windows/source/repos/C64Converter/Win/_deps/stb-subbuild/stb-populate-prefix/src/master.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/Windows/source/repos/C64Converter/Win/_deps/stb-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-stb-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-stb-populate${i}")
